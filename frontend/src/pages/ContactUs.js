        ...
        <div className="hero">
          <div className="column is-half is-offset-one-quarter">
            <div className="hero-body">
              <h2 className="subtitle">Please drop us a line with any feedback, comments or questions by completing the form below and someone will get back in touch with you as soon as possible.</h2>
