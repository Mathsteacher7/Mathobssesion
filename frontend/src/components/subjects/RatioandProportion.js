...
class RatioAndProportionIndex extends React.Component {
  ...
  componentDidMount() {
    axios.get('/api/exercises/')
      .then(res => this.setState({ data: res.data.filter(n => n.subjects.map(s => s.name).includes('Ratio and Proportion')) }))
  }
...
export default RatioAndProportionIndex
